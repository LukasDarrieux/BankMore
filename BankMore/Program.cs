...
builder.Services.AddMediatR(config => config.RegisterServicesFromAssembly(typeof(NewAccountCommand).Assembly));
...
builder.Services.AddSwaggerGen(c =>
{
    c.SwaggerDoc("v1", new OpenApiInfo
    {
        ...
        {
            Name = "BankMore",
            Email = "api@bankMore.com",
            Url = new Uri("https://www.bankMore.com/")
        }
    });
